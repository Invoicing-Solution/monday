...
const (
	...
	LocaleEtEE = "et-EE" // Estonian (Estonia)
	LocaleHrHR = "hr-HR" // Croatian (Croatia)
	LocaleLvLV = "lv-LV" // Latvian (Latvia)
	LocaleSkSK = "sk-SK" // Slovak (Slovakia)
	LocaleThTH = "th-TH" // Thai (Thailand)
	LocaleUzUZ = "uz-UZ" // Uzbek (Uzbekistan)
	LocaleKkKZ = "kk-KZ" // Kazakh (Kazakhstan)
)
